...
const Checkout = () => {
  ...
  return (
    <div className='container mx-auto px-4 py-8 min-h-[60vh]'>
      ...
      {
        loading ? <Loading/> : <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
            {
      ...
      <Button className='mt-6' variant='outline' onClick={()=>setModelOpen(true)}>Add New Address</Button>
      <Dialog open={modelOpen} onOpenChange={setModelOpen}>
        <DialogContent>
            ...
            <DialogFooter>
            <Button variant='outline' onClick={()=>setModelOpen(false)}>Close</Button>
