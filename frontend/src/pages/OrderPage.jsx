...
const OrderPage = () => {
    ...
    if(!order){
        return  <div className='min-h-[70vh] flex flex-col items-center justify-center text-center'>
            <h1 className='text-2xl font-bold text-gray-600'>No Order with this id</h1>
    ...
    <div className='container mx-auto py-6 px-4'>
        {
            ...
            </> : <p className='text-red-500 text-3xl text-center'>This is not your order
