...
const OrdersPage = () => {
  ...
  const filteredOrders = orders.filter((order)=>
    order.user.email.toLowerCase().includes(search.toLocaleLowerCase()) || order._id.toLocaleLowerCase().includes(search.toLocaleLowerCase())
  )
  ...
  return (
    <div className='p-6 spce-y-6'>
      ...
      <Input placeholder="search by email or order id"
        value={search}
